...
class StreamWishboneCommanderTest(MultiProcessTestCase):
    ...
    def test_simple(self):
        ...
        def source_process():
            ...
            yield from source_driver.produce_many([0xCA, 0xFE, 0xBA, 0xBE])
            ...
            yield from source_driver.produce_many([0xDE, 0xAD, 0xBE, 0xEF])
            yield from source_driver.produce_many([0x12, 0x34, 0x56, 0x78])
